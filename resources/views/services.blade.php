        ...
        @section('Quote-Info')
            ...
            <div class ="quote-container" id="quote-section">
                ...
                <div class = "documents-required">
                    ...
                    @foreach($quote->template_quote as $template)
                        @if(!empty($template->operation->config))
                        @foreach($template->operation->config->documents_required as $documents)
                            <div class = "document-list">
                                <li>
                                    {{$documentsMap[$documents->id] ?? 'Documento no encontrado'}}
                                </li>
                            </div>
                        @endforeach
                        @endif
